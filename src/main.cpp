...
static constexpr uint16_t freq = 5;
static constexpr uint16_t dt = 1000 / freq; // 1/freq * 1000ms/1s
static constexpr uint8_t dt1 = dt & 0xFF;
static constexpr uint8_t dt2 = dt >> 8;
static constexpr uint8_t CFG_RATE[12] = {0xB5, 0x62, 0x06, 0x08, 0x06, 0x00, dt1, dt2, 0x01, 0x00, 0x01, 0x00};
